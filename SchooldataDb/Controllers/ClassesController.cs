...
namespace SchooldataDb.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public ClassesController(CambridgeSchoolContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Classes != null ? 
                          ...
                          Problem("Entity set 'CambridgeSchoolContext.Classes'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CambridgeSchoolContext.Classes'  is null.");
            }
            var @class = await _context.Classes.FindAsync(id);
            if (@class != null)
            {
